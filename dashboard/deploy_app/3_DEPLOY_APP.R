...
# Version of R - 4.4.2
# Description - SOURCE THIS SCRIPT TO DEPLOY APP 
################################################################################.

#===============================================================================.
# Manual Variables - TO UPDATE ----

# MANUAL UPDATE: Update `user`, `password`, `token` and `secret` in `/conf/dementia/A&I/Outputs/dashboard/passwords.R`
# MANUAL UPDATE: Run 1_PREPARE_DATA.R
# MANUAL UPDATE: Run 2_CREATE_ADMIN_CREDENTIALS.R

# MANUAL UPDATE: Absolute path to the folder the app is being deployed from. Change analyst name.
filepath <- "/conf/dementia/A&I/Analysts/Lucy/dementia-pds/dashboard" 

# MANUAL UPDATE: Name of the app. Change year.
...
source(here::here("code", "publication", "00_setup-pub-environment.R")) # For checking setup is updated
load(here::here("dashboard", "data", "dashboard_variables.RData")) # For checking dashboard data is updated
