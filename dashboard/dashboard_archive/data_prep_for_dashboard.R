...
# 1 Load set up and save variables ----
source(here::here("code", "publication", "00_setup-pub-environment.R"))
save.image(file = here::here("dashboard/setup/dasboard_environment.RData"))

# 1 Load functions ----
source(here::here("dashboard_setup/summarise_functions_for_dashboard.R"))
...
readr::write_rds(annual_table_data, here::here("dashboard/data/annual_table_data.rds"))
...
readr::write_rds(data_sex, here::here("dashboard/data/data_sex.rds"))
readr::write_rds(data_age, here::here("dashboard/data/data_age.rds"))
readr::write_rds(data_simd, here::here("dashboard/data/data_simd.rds"))
...
# readr::write_rds(data_subtype, here::here("dashboard/data/data_subtype.rds"))
# readr::write_rds(data_stage, here::here("dashboard/data/data_stage.rds"))
# readr::write_rds(data_referral, here::here("dashboard/data/data_referral.rds"))
# readr::write_rds(data_model, here::here("dashboard/data/data_model.rds"))
# readr::write_rds(data_accom, here::here("dashboard/data/data_accom.rds"))
# readr::write_rds(data_uptake, here::here("dashboard/data/data_uptake.rds"))
...
readr::write_rds(data_wait, here::here("dashboard/data/data_wait.rds"))
...
readr::write_rds(data_rates, here::here("dashboard/data/data_rates.rds"))
...
readr::write_rds(download_data_scotland, here::here("dashboard/data/download_data_scotland.rds"))
...
readr::write_rds(download_data_hb, here::here("dashboard/data/download_data_hb.rds"))
...
readr::write_rds(download_data_ijb, here::here("dashboard/data/download_data_ijb.rds"))
