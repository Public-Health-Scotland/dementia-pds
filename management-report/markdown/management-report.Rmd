...
**Scotland** – Due to staffing issues the *2022/23* and *2023/24* Scotland figure does not include data from the following areas for the stated quarters : NHS Orkney 2022/23 (*Q1*, *Q2*, *Q3 and Q4*) and 2023/24 (*Q1*,*Q2* and *Q3*). 

**NHS Orkney** – PHS PDS Data Management Team are working with NHS Orkney to identify and fix issues with their data submissions. Currently these issues affect data for years *2020/21* to *2023/24*. 
