...
**Scotland** – Due to staffing issues the *2022/23* and *2023/24* Scotland figure does not include data from the following areas for the stated quarters : NHS Orkney 2022/23 (*Q3 and Q4*) and 2023/24 (*Q1*). 

**NHS Highland** – Due to staffing issues the Health Board are experiencing a wait to get a diagnosis for some patients and therefore there has been a delay in adding them to the PDS dataset in *Q1 2023/24.*

**NHS Orkney** – Due to ongoing staffing issues NHS Orkney were unable to provide data for 2022/23 (*Q3*, *Q4*) and 2023/24 (*Q1*).

**NHS Shetland** - NHS Shetland do not have a PDS worker in post for *2022/23* *Q2, Q3* and *Q4*, and *2023/24 Q1*. Therefore, NHS Shetland are unable to provide PDS allocation and contact dates for referrals in these quarters.  This explains the large increase seen in their query rate in *2022/23* as the waiting list will exceed 6 months for many. Once a PDS worker has been assigned these dates will be completed.
...
**NHS Tayside** – Due to local IT system issues the figures for *2018/19* and *2019/20* have been affected. 
