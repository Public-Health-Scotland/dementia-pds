...
# PDS data (output from 03_process_data.R)
pds <- read_rds(
  get_mi_data_path(
    type = "final_data", 
    ext = "rds", 
...
# European Standard Population lookup (output from 01_update-lookups.R)
...
query %>% 
  ...
  add_header_above(
        c(" " = 1,
          ...
          " " = 1)) %>%
  add_footnote(label = paste("A dash (\\-) indicates no records were submitted for diagnoses in this year."),
               notation = "none") 
```
