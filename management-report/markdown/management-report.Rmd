...
**NHS Tayside** – Due to local IT system issues the figures for *2018/19* and *2019/20* have been affected. PHS have identified issues with the data submitted by NHS Tayside for *2023/24* and *2024/25*, which has resulted in some records showing as incorrectly having met the standard. NHS Tayside has informed PHS that this is due to migrating their data to a new IT system. PHS are working with the Health Board to try and rectify this data issue in future submissions. 

**NHS Lanarkshire** - PHS have identified issues with the data submitted by NHS Lanarkshire for *2024/25* which has resulted in two records showing as incorrectly having met the standard. PHS are working with the Health Board to try and rectify this data issue in future submissions.

**NHS Borders** - PHS have identified issues with the data submitted by NHS Borders for *2024/25* which has resulted in one record showing as incorrectly having met the standard. PHS are working with the Health Board to try and rectify this data issue in future submissions.

**NHS Fife** - PHS have identified issues with the data submitted by NHS Fife for *2024/25* which has resulted in one record showing as incorrectly having met the standard. PHS are working with the Health Board to try and rectify this data issue in future submissions.
