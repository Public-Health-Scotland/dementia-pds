...
output: 
  flexdashboard::flex_dashboard:
    navbar:
      - title: "Data as at 30 September 2019"
...
Some text here about importance of data quality.
...
The table below shows the number of records submitted by each IJB. Any records with missing diagnosis date or diagnosis date out with the reporting period are not included in the below counts.
...
err %>%
  ...
  kable_styling(full_width = FALSE) %>%
  row_spec(length(unique(err$ijb)) + 1, bold = TRUE) %>%
