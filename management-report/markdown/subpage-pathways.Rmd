...
bscols(widths = 12,
    ...
    DT::datatable(not_met_table_data, container = headers_notmet,
                         rownames = FALSE,
                          caption = htmltools::tags$caption(
                          style = 'caption-side: bottom; text-align: left;',
                          "PDS terminated without contact refers to those with no contact date recorded and a termination date recorded at any time after diagnosis, therefore this may include referrals that were not contacted within 12 months of diagnosis."),
                         options = list(pageLength = 46,
                                        scrollX = FALSE,
                                        scrollY = TRUE,
                                        dom = "t",
