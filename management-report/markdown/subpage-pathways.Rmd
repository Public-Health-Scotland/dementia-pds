...
bscols(widths = 12,
    ...
    DT::datatable(not_met_table_data, container = headers_notmet,
                         rownames = FALSE,
                          caption = htmltools::tags$caption(
                          style = 'caption-side: bottom; text-align: left;',
                          "PDS terminated without contact includes those with a termination date recorded at any time after diagnosis."),
                         options = list(pageLength = 46,
                                        scrollX = FALSE,
                                        scrollY = TRUE,
                                        dom = "t",
