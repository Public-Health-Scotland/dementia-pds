...
not_met_data_totals <- left_join(pds_all_totals %>% 
    ...
    mutate(perc_of_total = paste0(round_half_up(100*total/total_referrals,1), "%"),
...
ongoing_data_totals <- left_join(pds_all_totals %>% 
   ...
   mutate(`% of Total referrals PDS Ongoing` = paste0(round_half_up(100*total/total_referrals,1), "%"),
                                              .after = total_referrals) %>% 
...
exempt_data_totals <- left_join(pds_all_totals %>% 
   ...
   mutate(`% of Total referrals Exempt` = paste0(round_half_up(100*total/total_referrals,1), "%"),
                                              .after = total_referrals) %>% 
  rename(`Integration Authority Area/Health Board` = geog, 
         `Total referrals` = total_referrals,
