...
median_data_ijb_plot <- SharedData$new(median_data_ijb, key = ~fy, group = "median_ijb")

data_filter_median <- filter_select(id = "filter_median",
                                    label = "Select Financial Year of Diagnosis:",
                                    group = ~fy,
                                    sharedData = median_data_ijb_plot,
                                    multiple = FALSE
                                   )
...
plot_bar_median(median_data_ijb_plot))
)
...
median_data_hb_plot <- SharedData$new(median_data_hb, key = ~fy, group = "median_hb")

data_filter_median_hb <- filter_select(id = "filter_median_hb",
                                    label = "Select Financial Year of Diagnosis:",
                                    group = ~fy,
                                    sharedData = median_data_hb_plot,
                                    multiple = FALSE
                                   )
...
bscols(widths = 12,
  div(style = css(width="98%", height="385px", marginBottom="-30px"),
plot_bar_median(median_data_hb_plot))
)
...
the number and percentage of total referrals whose PDS was ended with no contact date recorded. 
