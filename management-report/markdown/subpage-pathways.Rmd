...
This page shows pathways from dementia diagnosis to first contact by PDS practitioner. The Integration Authority Areas and Health Boards tabs include a chart and table showing the median number of days between diagnosis and contact for each geographical area by financial year.

The Trend tab includes a chart and table showing the trend of the median days between diagnosis and contact by financial year for Scotland, Integration Authority Areas and Health Boards.

The Waiting Times Breakdown tab includes a table showing the number of referrals, percentage of referrals allocated and contacted by PDS practitioner, and the median number of days between each pathway. 
...
<h4 style="margin-left: 60px; margin-top: 0px; margin-bottom: -10px; font-style: italic">Please note that waiting times for referral and allocation may be reflective of differences in the set up of local services</h4>
```{r wait-table-all}
bscols(widths = 12,
...
This page includes further information for referrals relating to the LDP Standard.
...
The PDS Ongoing tab includes a table showing the percentage of total referrals and number of individuals where the LDP Standard cannot yet be determined, along with the percentage of individuals where PDS has not yet started and less than 12 months since diagnosis and percentage of individuals still receiving PDS and less than 12 months since first contact for Scotland, Integration Authority Areas and Health Boards by financial year for years that are not yet finalised.
