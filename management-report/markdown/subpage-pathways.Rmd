...
bscols(widths = 12,
     ...
     DT::datatable(no_contact_table_data_ijb, rownames = FALSE, caption = htmltools::tags$caption(
                       style = 'caption-side: bottom; text-align: left;',
                       "A dash (-) indicates that this measure could not be calculated due to data quality issues. Referrals not contacted within 12 months of diagnosis includes records with no contact date and those with a contact date more than 12 months after diagnosis, but does not include those with a termination date. Number of referrals whose PDS ended with no contact refers to those with no contact date recorded and a termination date recorded at any time after diagnosis, therefore this may include referrals with a termination date more than 12 months after diagnosis."),
              options = list(pageLength = 33,
                             scrollX = FALSE,
                             scrollY = TRUE,
                             dom = "t",
