...
This page shows pathways from dementia diagnosis to first contact by PDS practitioner. The Integration Authority Areas and Health Boards tabs include a chart and table showing the median number of days between diagnosis and contact for each geographical area by financial year. Use the dropdown menus to select a year to show in the charts and tables.

The Trend tab includes a chart and table showing the trend of the median days between diagnosis and contact by financial year for Scotland, Integration Authority Areas and Health Boards. Use the dropdown menu to select multiple geographies to show in the chart. 

The Waiting Times Breakdown tab includes a table showing the number of referrals, percentage of referrals allocated and contacted by PDS practitioner, and the median number of days between each pathway. Use the dropdown menu to select a year to show in the table. 
...
<h2 style="margin-left: 70px; margin-top: 0px; margin-bottom: -20px"> Pathways from diagnosis to first contact by PDS practitioner </h2>
```{r wait-table-all}
bscols(widths = 12,
...
This page includes further information for referrals in regards to the LDP Standard.

The LDP Standard Not Met tab includes a table showing the number of individuals and percentage of total referrals who did not receive a minimum of one year’s PDS starting within 12 months of diagnosis, along with the percentage for each reason for not meeting the LDP Standard for Scotland, Integration Authority Areas and Health Boards by financial year.

The PDS Ongoing tab includes a table showing the number of individuals and percentage of total referrals where the LDP standard cannot yet be determined, along with the percentage of individuals who had not started within 12 months and individuals still receiving PDS within 12 months of their diagnosis for Scotland, Integration Authority Areas and Health Boards by financial year for years that are not yet finalised.

The Exempt tab includes a table showing the number of individuals and percentage of total referrals who are exempt from the LDP standard for Scotland, Integration Authority Areas and Health Boards by financial year.

Use the dropdown menus to select a year to show in the tables.
...
<h2 style="margin-left: 70px; margin-top: 0px; margin-bottom: -10px">Individuals who did not receive a minimum of one year’s PDS (Standard Not Met)</h2>
```{r not-met-table}
...
<h2 style="margin-left: 70px; margin-top: 0px; margin-bottom: -10px">Individuals where LDP Standard cannot yet be determined (PDS Ongoing)</h2>
```{r ongoing-table}
...
This page includes a table showing the number of individuals and percentage of total referrals with no contact by PDS practitioner within 12 months of contact, along with the number and percentage of total referrals whose PDS was ended with no contact for Integration Authority Areas and Health Boards with comparison to Scotland for each financial year. Use the dropdown menu to select a year to show in the table.
