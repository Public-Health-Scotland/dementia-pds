...
# Data quality notes - Aberdeen City
  ...
  scot_text <-  
    ...
    paste0(" ", 
             "**Please note:** ",
             "*PHS PDS Data Management Team are working with NHS Orkney to identify and " 
             "fix issues with their data submissions. Currently these issues affect data ", 
             "for years 2020/21 to 2023/24.*"),
            TRUE ~ paste0(""))
