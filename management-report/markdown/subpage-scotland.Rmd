...
# Data quality notes - Aberdeen City
  ...
  scot_text2 <- 
    case_when(sel_fy == extract_fin_year(scot_date4) |
              ...
              paste0(" ", 
              "**Please note:** ",
              "*PHS have identified issues with the data submitted by NHS Tayside (2023/24 ", 
              "and 2024/25), NHS Highland (2024/25 Q3) and NHS Lanarkshire (2024/25 Q3), which ",
              "has resulted in some records showing as incorrectly having ", 
              "met the standard. PHS are working with the Health Boards to try and rectify ", 
  ...
  wd_text <-  
    case_when(sel_fy == extract_fin_year(wd_date) ~
      paste0(" ",
             "**Please note:** ",
