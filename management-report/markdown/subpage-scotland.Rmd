    ...
    case_when(sel_fy == extract_fin_year(ac_date1) | sel_fy == extract_fin_year(ac_date2) ~
      paste0(" ",
        ...
        paste0(" ",
               ...
               "2025/26 Q1, hence they are showing as having no referrals for this quarter. ",
               "It is expected that data submission will resume in time for next quarter’s update.*"),
              TRUE ~ paste0(""))
