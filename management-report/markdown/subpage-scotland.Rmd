...
# Data quality notes - Aberdeen City
  ...
  scot_date1 <- dmy(01042020)
  scot_date2 <- dmy(01042021)
  scot_date3 <- dmy(01042022)
  scot_date4 <- dmy(01042023)
  
  scot_text <-  
    case_when(sel_fy == extract_fin_year(scot_date1) | 
              sel_fy == extract_fin_year(scot_date2) | 
              sel_fy == extract_fin_year(scot_date3) | 
  ...
  scot_text2 <- 
    case_when(sel_fy == extract_fin_year(scot_date4) ~
              ...
              "which has resulted in some records showing as incorrectly having met the standard. ",
              "PHS are working with the Health Board to try and rectify this data issue ",
