...
# Data quality notes - Aberdeen City
  ...
  tay_text <-  
    ...
    paste0(" ", 
           ...
           "to improve on data reporting from 2019 onwards.*"), TRUE ~ paste0(""))

  
  # Data quality notes - Scotland Q1 2022/23
  
  scot_date1 <- dmy(01042022)
  scot_date2 <- dmy(01042023)
  
  scot_text <-  
    case_when(sel_fy == extract_fin_year(scot_date1) | sel_fy == extract_fin_year(scot_date2) ~
    paste0(" ", 
           "**Please note:** ",
           "*Due to staffing issues the 2022/23 and 2023/24 Scotland figure does not include ",
           "data from the following areas for the stated quarters : NHS Orkney 2022/23 ",
           "(Q3 and Q4) and 2023/24 (Q1 and Q2)*"), 
            TRUE ~ paste0(""))
  
  scot_text2 <- 
    case_when(sel_fy == extract_fin_year(scot_date2) ~
              paste0(" ", 
              "**Please note:** ",
              "*PHS have identified issues with the data submitted by NHS Tayside for 2023/24, ",
              "which has resulted in some records showing as having met the standard at the end ",
              "of Q3. PHS will work with the Health Board to try and rectify this data issue ",
