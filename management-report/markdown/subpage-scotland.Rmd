  ...
  # Data quality notes - shetland
   ...
   fc_text <- 
    case_when(sel_fy == extract_fin_year(fc_date) ~
              paste0(" ", 
              "**Please note:** ",
              "*PHS have identified some records submitted by NHS Lanarkshire, NHS Borders and NHS Fife ", 
              ...
              "dates with the Health Boards and are expecting these to be rectified in future submissions.*"), 
            TRUE ~ paste0(""))
