...
# Data quality notes - Aberdeen City
  ...
  ac_text <-  
    case_when(sel_fy == fin_year(ac_date1) | sel_fy == fin_year(ac_date2) ~
      paste0(" ",
             "**Please note:** ",
  ...
  tay_text <-  
    case_when(sel_fy == fin_year(tay_date1) | sel_fy == fin_year(tay_date2) ~
    paste0(" ", 
           "**Please note:** ",
  ...
  scot_text <-  
    case_when(sel_fy == fin_year(scot_date1) | sel_fy == fin_year(scot_date2) ~
    paste0(" ", 
           "**Please note:** ",
  ...
  scot_text2 <- 
    case_when(sel_fy == fin_year(scot_date2) ~
              paste0(" ", 
              "**Please note:** ",
              ...
              "of Q2. PHS will work with the Health Board to try and rectify this data issue ",
