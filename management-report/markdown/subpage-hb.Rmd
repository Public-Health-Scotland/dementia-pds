...
# Data quality notes - Aberdeen City
  ...
  shetland_text <-  
   ...
   # Data quality notes - West Dunbartonshire
  wd_date <- dmy(01042024)

  wd_text <-  
    case_when(hb == "NHS Greater Glasgow & Clyde" & sel_fy == extract_fin_year(wd_date) ~
      paste0(" ",
             "**Please note:** ",
             "*Due to local IT system issues West Dunbartonshire ",
             "have not been able to provide all records for 2024/25. ",
             "PHS has been informed that this issue will ",
             "be rectified in future submissions.*"), TRUE ~ paste0(""))
  
  
   # Data quality notes - highland
  hlnd_date <- dmy(01042024)

  hlnd_text <-  
    case_when(hb == "NHS Highland" & sel_fy == extract_fin_year(hlnd_date) ~
      paste0(" ",
             "**Please note:** ",
              "*PHS have identified issues with the data submitted by NHS Highland for 2024/25 Q3 ",
              "which has resulted in one record showing as incorrectly having ", 
              "met the standard. PHS are working with the Health Board to try and rectify ", 
              "this data issue in future submissions.*"), TRUE ~ paste0(""))
  ...
  lan_text <-  
    case_when(hb == "NHS Lanarkshire" & sel_fy == extract_fin_year(lan_date) ~
      paste0(" ",
             "**Please note:** ",
              "*PHS have identified issues with the data submitted by NHS Lanarkshire for 2024/25 Q3 ",
              "which has resulted in one record showing as incorrectly having ", 
              "met the standard. PHS are working with the Health Board to try and rectify ", 
              "this data issue in future submissions.*"), TRUE ~ paste0(""))
