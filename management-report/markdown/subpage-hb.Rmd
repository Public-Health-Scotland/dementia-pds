...
# Data quality notes - Aberdeen City
  ...
  tay_text <-  
    case_when(hb == "NHS Tayside" & sel_fy == extract_fin_year(tay_date1) |
      ...
      hb == "NHS Tayside" & sel_fy == extract_fin_year(tay_date5)~
        paste0(" ", 
            "**Please note:** ",
  ...
  gramp_text <- case_when(
    hb == "NHS Grampian" & sel_fy == extract_fin_year(gramp_date1) |
      hb == "NHS Grampian" & sel_fy == extract_fin_year(gramp_date2) |
      hb == "NHS Grampian" & sel_fy == extract_fin_year(gramp_date3) ~
      paste0(" ", 
             "**Please note:** ",
...
flexdashboard::valueBox(if_else(!is.na(pds_rate),paste0(format(round_half_up(pds_rate, 1)), "%"), "-"), 
