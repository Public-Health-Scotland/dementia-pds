...
# Data quality notes - Aberdeen City
    ...
    case_when(hb == "NHS Tayside" & sel_fy == extract_fin_year(tay_date1) |
      ...
      hb == "NHS Tayside" & sel_fy == extract_fin_year(tay_date4)~
        paste0(" ", 
           ...
           "met the standard. NHS Tayside has informed PHS that this is due to migrating their ",
           "data to a new IT system. PHS are working with the Health Board to try and rectify ",
  ...
  fife_text <-  
    case_when(hb == "NHS Fife" & sel_fy == extract_fin_year(fife_date) ~
      paste0(" ",
             "**Please note:** ",
              "*PHS have identified issues with the data submitted by NHS Fife for 2024/25 ",
  ...
  bord_text <-  
    case_when(hb == "NHS Borders" & sel_fy == extract_fin_year(bord_date) ~
      paste0(" ",
             "**Please note:** ",
              "*PHS have identified issues with the data submitted by NHS Borders for 2024/25 ",
              "which has resulted in one record showing as incorrectly having ", 
              "met the standard. PHS are working with the Health Board to try and rectify ", 
              "this data issue in future submissions.*"), TRUE ~ paste0(""))
  ...
  lan_text <-  
    case_when(hb == "NHS Lanarkshire" & sel_fy == extract_fin_year(lan_date) ~
      paste0(" ",
             "**Please note:** ",
              "*PHS have identified issues with the data submitted by NHS Lanarkshire for 2024/25 ",
              "which has resulted in two records showing as incorrectly having ", 
              "met the standard. PHS are working with the Health Board to try and rectify ", 
              "this data issue in future submissions.*"), TRUE ~ paste0(""))
