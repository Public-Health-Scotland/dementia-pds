...
completeness_text <-
  case_when(
    ...
    sel_fy == fin_year(latest_final_year) ~ 
...
est_date3 <- dmy(01042023)
  ...
  est_text <-  
    case_when(sel_fy == fin_year(est_date1) | sel_fy == fin_year(est_date2) | sel_fy == fin_year(est_date3) ~
      paste0("",
             "**Please note:** ",
             "*Currently, the estimated and projected diagnosis rates for dementia in ",
             "Scotland are only available for years 2014-2020. ",
             "Therefore, the percentage of people estimated to be newly diagnosed with dementia ",
             "who were referred for post-diagnostic support ",
             "cannot be calculated for 2021/22, 2022/23 and 2023/24 at this time.* "), TRUE ~ paste0(""))
...
# Data quality notes - Aberdeen City
  ...
  ac_text <-  
    case_when(hb == "NHS Grampian" & sel_fy == fin_year(ac_date1) ~
      paste0("",
             "**Please note:** ",
      ...
      hb == "NHS Grampian" & sel_fy == fin_year(ac_date2) ~ 
              paste0("",
             "**Please note:** ",
             "When interpreting figures for Aberdeen City and NHS Grampian, ",
             "please take into account the following statement from Aberdeen ",
  ...
  tay_text <-  
    case_when(hb == "NHS Tayside" & sel_fy == fin_year(tay_date1)  ~
    paste0(" ", 
           "**Please note:** ",
    ...
    hb == "NHS Tayside" & sel_fy == fin_year(tay_date2) ~
        paste0(" ", 
           "**Please note:** ",
           "*NHS Tayside experienced challenges in capturing and reporting on electronic system data ",
           "within Perth & Kinross over the period 2018/19 to 2019/20. Despite local work undertaken to ",
           ...
           " Subsequent measures put in place have successfully allowed NHS Tayside ",
           "to improve on data reporting from 2019 onwards.*"),
    hb == "NHS Tayside" & sel_fy == fin_year(tay_date3) ~
        paste0(" ", 
           "**Please note:** ",
           "*PHS have identified issues with the data submitted by NHS Tayside for 2023/24, which ",
           "has resulted in some records showing as having met the standard at the end of Q2.",
  ...
  text22_23 <-  
    case_when(hb == "NHS Orkney" & sel_fy == fin_year(date22_23) | hb == "NHS Orkney" & sel_fy == fin_year(date23_24) ~ 
              paste0("",
             "**Please note:** ",
             ...
             "2022/23 (Q3 and Q4) and 2023/24 (Q1 and Q2).*"),
              hb == "NHS Grampian" & sel_fy == fin_year(date22_23) ~
               paste0("",
             "**Please note:** ",
             ...
             hb == "NHS Shetland" & sel_fy == fin_year(date22_23) | hb == "NHS Shetland" & sel_fy == fin_year(date23_24) ~
               paste0("",
             "**Please note:** ",
             "*NHS Shetland do not have a PDS worker in post for 2022/23 Q2 and Q3",
             "and 2023/24 Q1 and Q2, therefore are unable to provide PDS allocation and contact dates for referrals ",
             "in these quarters. This explains the large increase seen in their query rate in 2022/23 ",
             "as the waiting list will exceed 6 months for many. Once a PDS worker has been assigned ",
             "these dates will be completed.*"),
      TRUE ~ paste0(""))
