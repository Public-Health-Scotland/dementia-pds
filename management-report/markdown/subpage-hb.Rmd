...
completeness_text <-
  case_when(
    ...
    TRUE ~ 
      paste0("As ", 
             subpage_data %>% filter(ldp == "ongoing") %>% {sum(.$referrals)}, 
             " referrals in ", sel_fy, " are still ongoing, it is not yet ",
             "known whether they will meet the LDP standard to receive a ",
             "minimum of 12 months support. Therefore, this figure ", 
             "is likely to change in future versions of this report.")
  )
