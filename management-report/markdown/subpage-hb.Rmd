...
The expected number of new dementia diagnoses is <span style="color:blue"><font size="4">**`r exp`**</font></span>. 

The number of referrals to post diagnostic support is <span style="color:blue"><font size="4">**`r ref`**</font></span>.
...
Of the `r ref` referrals to post diagnostic support, `r ref - den` are still undergoing PDS. Of the remaining `r den`, `r num` have met the LDP standard. This includes those who have completed 12 months of PDS and those who are exempt.
...
subpage_data %>%
  ...
  arrange(match(ijb, c(hb, unique(subpage_data$ijb)))) %>%
