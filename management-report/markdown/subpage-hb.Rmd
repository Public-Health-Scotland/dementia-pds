...
est_date3 <- dmy(01042023)
  ...
  est_text <-  
    case_when(sel_fy == extract_fin_year(est_date1) | sel_fy == extract_fin_year(est_date2) | sel_fy == extract_fin_year(est_date3) ~
      paste0("",
             "**Please note:** ",
             "For financial years *2021/22, 2022/23 and 2023/24,* the estimated and projected diagnosis rates "
             "referenced in the report published by the Scottish Government "
...
# Data quality notes - Aberdeen City
  ...
  tay_text <-  
    ...
    hb == "NHS Tayside" & sel_fy == extract_fin_year(tay_date3) ~
        paste0(" ", 
           ...
           "has resulted in some records showing as having met the standard at the end of Q3.",
           "PHS will work with the Health Board to try and rectify this data issue in future ",
           "submissions.*"),
    TRUE ~ paste0(""))
  ...
  text22_23 <-  
    case_when(hb == "NHS Orkney" & sel_fy == extract_fin_year(date22_23) | hb == "NHS Orkney" & sel_fy == extract_fin_year(date23_24) ~ 
              paste0("",
             "**Please note:** ",
             "*Due to IT staff issues and lack of access to a Consultant Psychiatrist",
             " in 2022/23 and 2023/24, NHS Orkney were unable to provide data for ",
             "2022/23 (Q3 and Q4) and 2023/24 (Q1 and Q2).*"),
              hb == "NHS Grampian" & sel_fy == extract_fin_year(date22_23) ~
               paste0("",
             "**Please note:** ",
