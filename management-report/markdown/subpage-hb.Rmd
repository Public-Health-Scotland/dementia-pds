...
# Data quality notes - Aberdeen City
  ...
  orkney_text <- case_when(hb == "NHS Orkney" & sel_fy == extract_fin_year(date20_21) | 
            ...
            hb == "NHS Orkney" & sel_fy == extract_fin_year(date23_24) ~ 
              paste0(" ",
             "**Please note:** ",
             "*PHS PDS Data Management Team are working with NHS Orkney to identify ", 
             "and fix issues with their data submissions. Currently these issues affect ", 
             "data for years 2020/21 to 2023/24.*"),
            hb == "NHS Orkney" & sel_fy == extract_fin_year(date22_23) | 
            hb == "NHS Orkney" & sel_fy == extract_fin_year(date23_24) ~ 
              paste0(" ",
             "**Please note:** ",
             "*NHS Orkney had no referrals in 2022/23 (Q3 and Q4) and 2023/24 (Q1 and Q2) ", 
