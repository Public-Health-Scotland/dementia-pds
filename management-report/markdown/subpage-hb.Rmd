...
# Data quality notes - Aberdeen City
  ...
  tay_text <-  
    ...
    paste0(" ", 
      ...
      hb == "NHS Tayside" & sel_fy == extract_fin_year(tay_date4)~
        paste0(" ", 
           "**Please note:** ",
           "*PHS have identified issues with the data submitted by NHS Tayside for 2023/24 and 2024/25, which ",
  ...
  orkney_text <- case_when(hb == "NHS Orkney" & sel_fy == extract_fin_year(date20_21) | 
            ...
            hb == "NHS Orkney" & sel_fy == extract_fin_year(date23_24) ~ 
              paste0(" ",
             "**Please note:** ",
             "*NHS Orkney had no referrals in 2022/23 (Q3 and Q4) and 2023/24 (Q1 and Q2) as they were unable, "
             "to access a consultant psychiatrist.*"),
    TRUE ~ paste0(""))
  ...
  shetland_text <-  
    case_when(hb == "NHS Shetland" & sel_fy == extract_fin_year(date22_23) | hb == "NHS Shetland" & sel_fy == extract_fin_year(date23_24) ~
               paste0(" ",
             "**Please note:** ",
              "*NHS Shetland did not have a PDS worker in post from 2022/23 Q1 through 2023/24 Q3. As a result not all ",  
              "people referred to PDS could be allocated or contacted by a PDS worker within 12 months of diagnosis, ", 
              "hence they have been recorded as not having met the standard. A PDS worker was assigned in 2023/24 Q4",
