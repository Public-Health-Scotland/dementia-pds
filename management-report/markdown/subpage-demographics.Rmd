...
ldp_all_age_2$age_grp_2<- factor(ldp_all_age_2$age_grp_2, levels = c("65+", "64 and Under"))
...
pds_all_age_2_rates$age_grp_2<- factor(pds_all_age_2_rates$age_grp_2, levels = c("65+", "64 and Under"))
...
function filter_default() {
  ...
  [0].selectize.setValue("1 - Most Deprived", false);
