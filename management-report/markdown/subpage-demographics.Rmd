...
pds_all_totals_2$age_grp_2<- factor(pds_all_totals_2$age_grp_2, levels = c("All", "79 and Under", "80 to 84", "85+"))
...
pds_ijb_totals_2$age_grp_2<- factor(pds_ijb_totals_2$age_grp_2, levels = c("All", "79 and Under", "80 to 84", "85+"))
...
pds_hb_totals_2$age_grp_2<- factor(pds_hb_totals_2$age_grp_2, levels = c("All", "79 and Under", "80 to 84", "85+"))
...
pds_scot_totals_2$age_grp_2<- factor(pds_scot_totals_2$age_grp_2, levels = c("All", "79 and Under", "80 to 84", "85+"))
...
This page includes rates of the number of people referred to PDS per 10,000 population (65 years and over) for given age groups. The Integration Authority Area and Health Board tabs include a chart and table showing the rates for each geographical area. Use the dropdown menus to select a year to show in the charts and tables. For the Integration Authority tab use the dropdown menu to filter for selected areas to show in the charts and tables.

The Trend tab includes a chart and table showing the trend of the rate by financial year for Scotland and a selected Integration Authority Area or Health Board for each age group. Use the dropdown menu to select a geographical area to show in the chart alongside the trend for Scotland.

*The rate per 10,000 population for each age group is calculated using the number of referrals in the given age group and the estimated population of the same age group for each geographical area (the population used for the ‘79 and Under’ age group is 65 to 79). See the [Glossary](#glossary) page for more details.*
...
This page shows the percentage of referrals that have received one year's support which started within a year of diagnosis (or have been exempt from the LDP Standard) for given age groups. The Integration Authority Area and Health Board tabs include a chart and table showing the percentages for each geographical area. Use the dropdown menus to select a year to show in the charts and tables. For the Integration Authority tab use the dropdown menu to filter for selected areas to show in the charts and tables.

The Trend tab includes a chart and table showing the trend of the percentage by financial year for each age group for a selected geographical area. Use the dropdown menus to select a geographical area to show in the chart and table.
...
This page includes rates of the number of people referred to PDS per 10,000 population (65 years and over) for males and females. The Integration Authority Area and Health Board tabs include a chart and table showing the rates for each geographical area. Use the dropdown menus to select a year to show in the charts and tables.

The Trend tab includes a chart and table showing the trend of the rate by financial year for Scotland and a selected Integration Authority Area or Health Board for each gender. Use the dropdown menu to select a geographical area to show in the chart alongside the trend for Scotland.

*The rate per 10,000 population for each gender is calculated using the number of referrals with the given gender and the estimated population of the same gender for each geographical area. See the [Glossary](#glossary) page for more details.*
...
This page shows the percentage of referrals that have received one year's support which started within a year of diagnosis (or have been exempt from the LDP Standard) for males and females. The Integration Authority Area and Health Board tabs include a chart and table showing the percentages for each geographical area. Use the dropdown menus to select a year to show in the charts and tables.

The Trend tab includes a chart and table showing the trend of the percentage by financial year for each gender for a selected geographical area. Use the dropdown menus to select a geographical area to show in the chart and table.
...
This page includes rates of the number of people referred to PDS per 10,000 population (65 years and over) for SIMD (Scottish Index of Multiple Deprivation) quintiles. The Integration Authority Area and Health Board tabs include a chart and table showing the rates for each geographical area. Use the dropdown menus to select a year to show in the charts and tables. For the Integration Authority tab use the dropdown menu to filter for selected areas to show in the charts and tables.

The Trend tab includes a chart and table showing the trend of the rate by financial year for Scotland and a selected Integration Authority Area or Health Board for each quintile. Use the dropdown menu to select a geographical area to show in the chart alongside the trend for Scotland.

*The rate per 10,000 population for each SIMD quintile is calculated using the number of referrals in the given quintile and the estimated population of the same quintile for each geographical area. See the [Glossary](#glossary) page for more details.*
...
This page shows the percentage of referrals that have received one year's support which started within a year of diagnosis (or have been exempt from the LDP Standard) for SIMD (Scottish Index of Multiple Deprivation) quintiles. The Integration Authority Area and Health Board tabs include a chart and table showing the percentages for each geographical area. Use the dropdown menus to select a year to show in the charts and tables. For the Integration Authority tab use the dropdown menu to filter for selected areas to show in the charts and tables.

The Trend tabs include a chart and table showing the trend of the percentage by financial year for each SIMD quintile for a selected geographical area. Use the dropdown menus to select a geographical area to show in the charts and tables.
