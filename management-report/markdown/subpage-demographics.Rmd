...
bscols(widths = 12,
       div(style = css(width="97%", height="435px", margin="20px"),
...
```{r plot-hb-age-legend-pop}

bscols(widths = 12,
div(style=css(marginBottom="-10px",height="65px"), plot_geog_bar_legend(pds_all_age %>% filter(geog == "Scotland"), measure = age_grp_2, colours = age_colours)))
...
bscols(widths = 12,
  div(style = css(width="98%", height="365px", marginBottom="0px"),
...
bscols(widths = 12,
       div(style = css(width="97%", height="460px", margin="20px", marginTop ="45px"),
...
```{r plot-hb-age-legend-ldp}
 ...
 bscols(widths = 12,
div(style=css(marginBottom="-10px",height="65px"), plot_geog_bar_legend(ldp_all_age %>% filter(geog == "Scotland"), measure = age_grp_2, colours = age_colours)))
...
bscols(widths = 12,
       div(style = css(width="97%", height="460px", margin="20px", marginTop="40px"),
...
```{r plot-ijb-sex-pop}
bscols(widths = 12,
  div(style = css(width="98%", height="385px", marginBottom="-20px"),
...
This page includes rates of the number of people referred to PDS per 10,000 population (65 years and over) for SIMD (Scottish Index of Multiple Deprivation) quintiles. *See the [Glossary](#glossary) for more details.*
...
This page shows the percentage of referrals that have received one year’s support which started within a year of diagnosis (or have been exempt from the LDP Standard) for SIMD (Scottish Index of Multiple Deprivation) quintiles.  
...
The Trend tabs include a chart showing the trend of the percentage by financial year for the selected geographical area for each SIMD quintile. The table below the charts shows the figures for the selected geographical area. 
