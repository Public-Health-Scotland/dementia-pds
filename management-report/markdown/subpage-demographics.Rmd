...
<h2 style="margin-left: 70px; margin-top: 0px; margin-bottom: 20px"> People referred to PDS per 10,000 population by Age Group </h2>
...
bscols(widths = c(1,1,1,NA),NULL,
       div(style = css(width="100px", height="20px"),
plot_ldp_simd_line_legend_1(ldp_all_simd %>% filter(geog == "Scotland"))),NULL,
      div(style = css(width="100%", height="23px"),
plot_ldp_simd_line_legend_2(ldp_all_simd %>% filter(geog == "Scotland")))
)
...
bscols(widths = 12,
  div(style = css(width="98%", height="370px"),
plot_ldp_simd_line(ldp_all_simd_data))
)
