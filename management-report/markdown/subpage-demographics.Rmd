...
pds_age_data <- SharedData$new(pds_all_age)
...
<div>
```{r plot-prop-age, fig.height=5}

  trends_prop_plot <- plot_trend_prop(pds_age_data)
  trends_prop_plot
...
function filter_default_age() {
  ...
  window.onload = filter_default_age;
