...
bscols(widths = 12,
       div(style = css(width="97%", height="610px", margin="20px"),
...
<h2 style="margin-left: 70px; margin-top: 0px; margin-bottom: 15px">Percentage of referrals who received a minimum of one year’s PDS by SIMD Quintile and Financial Year </h2>
