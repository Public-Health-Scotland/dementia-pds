...
This page includes a chart and table showing the trend for number of people referred to PDS by financial year for Scotland, Integration Authority Areas and Health Boards. For the Integration Authority Areas and Health Boards tabs use the dropdown menus to select multiple geographies to show in the charts.  
...
trends_plot_ijb <- plot_trend(pds_trends_data_ijb, total_referrals, x ="Financial Year of Diagnosis", y = "Number Referred", measure_text = "Referrals: ")
...
trends_plot_hb <- plot_trend(pds_trends_data_hb, total_referrals, x ="Financial Year of Diagnosis", y = "Number Referred", measure_text = "Referrals: ")
...
This page includes rates of the number of people referred to PDS per 10,000 population (65 years and over). The Integration Authority Area and Health Board tabs include a chart and table showing the rate for each geographical area by financial year. Use the dropdown menus to select a year to show in the charts. 

The Trend tab includes a chart and table showing the trend of the rate by financial year for Scotland, Integration Authority Areas and Health Boards. Use the dropdown menu to select multiple geographies to show in the chart. 

*The rate per 10,000 population is calculated using the number of referrals with a dementia diagnosis date in the given financial year and the estimated population of the same year for each geographical area. See the [Glossary](#glossary) page for more details.*
...
This page includes charts and tables showing the trend by financial year for information in regards to the LDP Standard. The first tab shows the percentage of the estimated number of people newly diagnosed with dementia that have been referred to PDS for Scotland and Health Boards (estimates are not available for Integration Authority Areas).
...
Use the dropdown menus to select multiple geographies to show in the charts.
