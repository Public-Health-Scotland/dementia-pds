...
This page includes rates of the number of people referred to PDS per 10,000 population (65 years and over). Note that for financial year *2025/26* and *2026/27* the Mid-2025 populations are used as this is the latest available estimate.<!-- UPDATE when new population estimates are available / when new financial year begins --> *See the [Glossary](#glossary) for more details.*
