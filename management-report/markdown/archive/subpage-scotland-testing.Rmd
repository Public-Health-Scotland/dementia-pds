  ...
  case_when(
    ...
    complete_year == FALSE ~ 
      paste0("As PDS for some referrals in ", sel_fy, " is still ",
             ...
             "change in future versions of this report.", "<br>", "<br>",
...
<ul style="list-style-type:square;">
   <li >[Standard Not Met / PDS Ongoing](#outcomes)</li>
...
`r if(complete_year == TRUE & sel_fy %in% finalised_years){glue("<span style='color:CornflowerBlue'>**{num_format}**</span> referrals either met or were exempt from the LDP standard. This is divided by <span style='color:CornflowerBlue'>**{den_format}**</span>, the total number of referrals.")} else if(complete_year == TRUE & !sel_fy %in% finalised_years){glue("<span style='color:CornflowerBlue'>**{num_format}**</span> referrals either met or were exempt from the LDP standard. This is divided by <span style='color:CornflowerBlue'>**{den_format}**</span>, the total number of referrals (excluding those whose support is ongoing)."} else{""}`
