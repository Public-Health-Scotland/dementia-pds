...
### PDS Quarterly Report
#### `r paste0(current_fy, " Q", qt)`
...
<ul style="list-style-type:square;">
  ...
  <li style="font-size: 20px;">[User Guide](#user-guide)</li>
</ul>
...
This page includes information about data quality. Any queries/errors outstanding following the resubmission deadline will be included in analytical outputs such as these management reports and annual publication. Therefore, the better quality of data submitted, the more accurate these figures will be. See the [Glossary](#glossary) page for more information.
