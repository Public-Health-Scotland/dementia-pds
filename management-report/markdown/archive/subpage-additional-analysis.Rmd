...
data_filter_model_prop <- filter_select(id = "filter_model_prop_ijb",
...
data_filter_model_prop <- filter_select(id = "filter_model_prop_hb",
                                    label = "Select Financial Year of Diagnosis:",
                                    group = ~fy,
...
bscols(widths = 12,
       div(style = css(width="98%", height="710px", margin="15px"),
          DT::datatable(table_ijb_carer, rownames = FALSE, caption = htmltools::tags$caption(
...
bscols(widths = 12,
       div(style = css(width="98%", height="660px", margin="15px"),
          DT::datatable(table_hb_carer, rownames = FALSE,  caption = htmltools::tags$caption(
                       style = 'caption-side: bottom; text-align: left;',
                       "Note that Carer's Support is an optional field."),
