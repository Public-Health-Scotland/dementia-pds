...
pop_data_sex <- pop_data %>% filter(age_grp == "All", age_grp_2 == "65+", sex != "All") %>% select(-age_grp, -age_grp_2) %>% mutate(sex = substring(sex, 4))
...
pop_data_simd <- simd_pop_data %>% filter(sex == "All", age_grp == "All", age_grp_2 == "65+") %>% select(-sex, -age_grp, -age_grp_2)
