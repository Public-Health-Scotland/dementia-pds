...
Information is shown at Scotland, Health Board and Integration Authority Area level using the drop down menus at the top of the page.
...
**Population Estimates:** The population estimates used in this report are from the National Records of Scotland (NRS) Mid-year population estimates and the NRS Population estimates by Scottish Index of Multiple Deprivation (SIMD). As figures in this report are by financial year, the estimate for the calendar year with the majority of months in the selected financial year is used. For example, analysis for financial year 2018/19 uses estimations for the calendar year 2018. The estimates used throughout the report are for the population that is 65 years and older, as 97.4% of referrals to PDS are in this age group. 
...
Across the reported years there are a small number of records (12 in total) with an incomplete date of birth and therefore the age group is unknown. These records have been excluded from the age group analysis. 

*For the rates calculations, for financial year 2024/25 the Mid-2023 populations are used as this is the latest available estimate.*  

**Gender:** Gender is based on the sex recorded for each referral.  

Across the reported years there are 33 records in total where sex is either not specified (includes refused/not provided) or not known (i.e. indeterminate sex, includes ‘Intersex’). These records have been excluded from the gender analysis.
...
Across the reported years there are 56 records where it was not possible to assign a deprivation quintile based on the postcode information available. These records have been excluded from the deprivation analysis. 

*For the rates calculations, for financial years 2023/24 and 2024/25 the Mid-2022 populations are used as this is the latest available estimate.* 
