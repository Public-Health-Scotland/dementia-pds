...
```{r dropdown-met}
met_data <- pds_all %>% filter(ldp == "complete") %>% group_by(geog, fy, ldp_full) %>% 
...
function filter_default() {
  ...
  document.getElementById("trend_filter_sex_prop_hb").getElementsByClassName("selectized") 
  [0].selectize.setValue("2023/24", false);

  document.getElementById("trend_filter_sex_prop_hb").getElementsByClassName("selectized")
  [0].selectize.removeOption("");
  
   document.getElementById("trend_filter_sex_prop_ijb").getElementsByClassName("selectized") 
  [0].selectize.setValue("2023/24", false);
