...
### **Scotland - Number of Individuals Diagnosed and Referred for PDS** 
...
```{r ldp-table}
 ...
 bscols(widths = c(1,10,1),NULL,
            div(style = css(width="109%", height="700px", marginLeft="-50px"),
ldp_table_dt(subpage_data,
          scotland = TRUE,
          ijb = FALSE,
          sel_fy,
          qt,
...
```{r ldp-table-2}
 ...
 bscols(widths = c(1,10,1),NULL,
            div(style = css(width="109%", height="1310px", marginLeft="-50px"),
ldp_table_dt(subpage_data,
          scotland = FALSE,
          ijb = TRUE,
          sel_fy,
