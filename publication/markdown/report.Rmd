...
age_footnote <-
  paste("Age is calculated as at the dementia diagnosis date. There are",
        "a small number of records with and incomplete date of birth and",
        "therefore the age is unknown.")

simd_footnote <- 
  paste("1.	Deprivation is calculated by matching postcodes to the",
...
Table 2 presents the percentage of estimated number of people newly diagnosed with dementia referred for post-diagnostic support (PDS) by financial year from `r fy_in_pub[1]` to `r latest_fy` by NHS Board.

<Div custom-style = "TableChart title">Table 2: Trend of Percentage of estimated number of people newly diagnosed with dementia referred for post-diagnostic support (PDS) by NHS Board</Div>
...
This part of LDP standard reports on the number of people referred for dementia post-diagnostic support who received a minimum of one year’s support. Figures presented in this section should be interpreted in conjunction with [section 1](#section1).
...
Table 4 below presents the trend of percentage of people referred for post-diagnostic support who received a minimum of one year’s support by NHS Board.

<Div custom-style = "TableChart title">Table 4: Trend of percentage of people referred for dementia post-diagnostic support (PDS) who received a minimum of one year’s support by NHS Board</Div>
...
Table 5 below presents the number and percentage of people referred for post-diagnostic support who received a minimum of one year’s support by Integration Joint Board (IJB).
...
Table 6 below presents the trend of percentage of people referred for post-diagnostic support who received a minimum of one year’s support by Integration Joint Board (IJB).

<Div custom-style = "TableChart title">Table 6: Trend of percentage of people referred for dementia post-diagnostic support (PDS) who received a minimum of one year’s support by Integration Joint Board</Div>
...
Figure 4 below presents the age distribution of those referred for dementia post-diagnostic support for `r latest_fy`.
...
Figure 5 below presents the percentage of those referred for dementia post-diagnostic support who received a minimum of one year’s support by age group for `r latest_fy`. 
...
Figure 7 below presents the percentage of those referred for dementia post-diagnostic support who received a minimum of one year’s support by deprivation quintile for `r latest_fy`. 
