...
shet_footnote <- paste0("NHS Shetland did not have a PDS worker in post from 2022/23 Q1 through 2023/24 Q3. ",
                        "As a result not all people referred to PDS could be allocated or contacted by a PDS ",
                        "worker within 12 months of diagnosis, hence they have been recorded as not having ",
                        "met the standard. ",
                        "See [Appendix 1](#reporting) for further information.")
...
<Div custom-style = "Table or chart caption">Figure 6: Distribution of referrals to dementia post-diagnostic support by deprivation quintile; `r latest_fy`^1,2`r if(simd_unknown != 0){paste(",3")`^</Div>
...
2. `r prov_footnote`
`r if(simd_unknown != 0){paste("3.",simd_footnote)}`
</Div>
