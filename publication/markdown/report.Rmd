...
```{r Figures, echo = FALSE, message = FALSE, warning = FALSE, error = FALSE, include = FALSE}
library(ggplot2)
library(scales)
library(captioner)
library(flextable)
...
<Div custom-style = "Publication subtitle">This is a Management Information Publication</Div>
...
https://code.statisticsauthority.gov.uk/national-statisticians-guidance-management-information-and-official-statistics-3/
<br>
...
include_graphics(
  here("publication", "output", pub_date, paste0(pub_date, "_chart.png")), 
  dpi = 600
)
```
</div>
