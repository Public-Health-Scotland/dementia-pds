...
This release by Public Health Scotland (PHS) reports on the Scottish Government’s Local Delivery Plan (LDP) standard that all those newly diagnosed with dementia should have a minimum of one year’s post-diagnostic support. Data are presented by financial year of diagnosis and this report presents finalised figures for `r nth(fy_in_pub, -2)` and provisional figures for `r latest_fy` which are subject to some service users completing their support.
